...
export default function ContactPage() {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Hubungi Kami / Booking Kamar – Kost Griya Matahari</title>
        <meta name="description" content="Kontak telepon & WhatsApp resmi pengelola Kost Griya Matahari Klungkung Bali (Ayu Sri: +628124605815, Kuswara: +628970474149) untuk booking atau survey lokasi." />
        <link rel="canonical" href="https://griyamatahariklungkung.com/contact" />
      </Helmet>
      ...
      <div className="relative w-full lg:w-1/2 min-h-[400px] lg:min-h-0 bg-base-200">
        <iframe
          ...
          title="Lokasi Kost Griya Matahari"
        />
        ...
        <div className="max-w-xl mx-auto w-full space-y-8">
          ...
          <div>
            ...
            <h1 className="text-3xl sm:text-5xl font-black leading-tight text-base-content" style={{ fontFamily: 'Poppins, sans-serif' }}>
              Pesan Kamar Lewat <span className="bg-gradient-to-r from-yellow-500 to-orange-500 bg-clip-text text-transparent">WhatsApp</span>
            </h1>
          ...
          <div className="bg-gradient-to-br from-green-500/15 via-emerald-500/5 to-base-200 border border-green-500/30 p-8 rounded-[2rem] space-y-6 shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                href="https://wa.me/628124605815?text=Halo%20Kost%20Griya%20Matahari%2C%20saya%20tertarik%20ingin%20tanya%20informasi%20booking%20kamar."
              ...
              <a
                href="https://wa.me/628970474149?text=Halo%20Kost%20Griya%20Matahari%2C%20saya%20tertarik%20ingin%20tanya%20informasi%20booking%20kamar."
                target="_blank" rel="noopener noreferrer"
                className="btn btn-success btn-lg rounded-2xl flex-1 gap-2 font-extrabold text-sm hover:scale-[1.03] transition-transform shadow-lg shadow-success/20"
              >
                <MessageCircle size={18} />
